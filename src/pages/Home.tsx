...
import { Brain, Smartphone, Server, Video, Sun, Cable, Wrench, ShoppingCart, Star, TrendingUp, Users, Award, CheckCircle, Palette, Headphones, AlertTriangle, ShieldCheck, Zap } from 'lucide-react'
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mt-8">
            <Link to="/pricing" className="text-sm text-white/50 hover:text-white underline underline-offset-4 transition-colors">

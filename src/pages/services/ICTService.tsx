      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-10 items-center mb-20">
          <div>
            ...
            <div className="flex gap-3">
              <Link to="/quote?service=ICT Support" className="btn-primary">Get Support</Link>
        ...
        <GlassCard className="p-8 text-center border-hh-red/20">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/quote?service=ICT Support" className="btn-primary inline-flex items-center gap-2">Request Support <ArrowRight size={16} /></Link>
          </div>
        </GlassCard>
      </div>
    </div>

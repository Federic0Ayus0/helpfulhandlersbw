    ...
    <div className="min-h-screen bg-hh-bg-primary grid-bg pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-10 items-center mb-20">
          <div>
            ...
            <div className="flex gap-3">
              <Link to="/quote?service=Software Service" className="btn-primary">Discuss Your Project</Link>
        ...
        <GlassCard className="p-8 text-center border-hh-red/20">
          ...
          <Link to="/quote?service=Software Service" className="btn-primary inline-flex items-center gap-2">Get a Free Quote <ArrowRight size={16} /></Link>
        </GlassCard>
      </div>
    </div>
  )

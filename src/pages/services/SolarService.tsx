    ...
    <div className="min-h-screen bg-hh-bg-primary grid-bg pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-10 items-center mb-20">
          <div>
            ...
            <div className="flex gap-3">
              <Link to="/quote?service=Solar Service" className="btn-primary">Get a Solar Quote</Link>
        ...
        <GlassCard className="p-8 text-center" style={{ borderColor: 'rgba(234,179,8,0.2)' }}>
          ...
          <Link to="/quote?service=Solar Service" className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-medium px-6 py-3 rounded-lg hover:brightness-110 transition-all">Get a Free Quote <ArrowRight size={16} /></Link>
        </GlassCard>
      </div>
    </div>
  )

    ...
    <div className="min-h-screen bg-hh-bg-primary grid-bg pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-hh-red/30 bg-hh-red/10 text-xs font-medium text-hh-red mb-4">
            <ShoppingCart size={12} /> Hardware & ICT Solutions Gallery
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            Hardware & <span className="gradient-text-red">ICT Solutions</span> Gallery
          </h1>
            ...
            <GlassCard key={p.name} className="overflow-hidden group">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/quote" className="text-xs font-medium text-hh-red hover:text-white transition-colors border border-hh-red/30 hover:bg-hh-red px-3 py-1.5 rounded-full">
                    Get Quote
                  </Link>
                </div>
              </div>
        ...
        <GlassCard className="p-8 text-center border-hh-red/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl font-bold mb-3">Need help choosing the right hardware?</h2>
      ...
      <div className="fixed bottom-6 right-6 glass-nav rounded-xl border border-white/10 p-4 max-w-xs z-40 shadow-xl">
        <div className="flex items-center gap-3">
          <img src="/images/mascot-avatar.png" alt="Support" className="w-10 h-10 rounded-full object-cover" />
          <div>
